        ...
        with open('RQ/RQ1_2.csv', 'w') as rq1_2_csv, open ('RQ/RQ1_3.csv', 'w') as rq1_3_csv, open ('RQ/RQ2.csv', 'w') as rq2_csv:
            ...
            while True:                
                ...
                for i in range(energy):
                    ...
                    end_time_gen_test = time.now()
                    elapsed_time_gen_test = end_time_gen_test - start_time_per_test
                    ...
                    if self.is_interesting():
                        lap_time = time.now()
                        elapsed_time = lap_time - start_time
                        interesting_test_cases += 1
                        self.seed_queue.append(mutated_seed)    
                        
                    # RQ 2 time to run test
                    end_time_run_test = time.now()
                    elapsed_time_run_test = end_time_run_test - start_time_per_test
